...
public class DownloadInfo {
    ...
    public DownloadInfo(int id, String uri, boolean noIntegrity, String hint, String fileName, String mimeType, int destination, int visibility,
                        int control, int status, int numFailed, int retryAfter, int redirectCount, long lastMod, String pckg, String clazz, String extras,
                        String cookies, String userAgent, String referer, int totalBytes, int currentBytes, String eTag, boolean mediaScanned) {
        mId = id;
        mUri = uri;
        ...
        mFuzz = InfoHelpers.sRandom.nextInt(1001);
    }
    ...
    /**
     * Returns whether this download (which the download manager has already seen and therefore
     * potentially started) should be restarted.
     * <p>
     * In a nutshell, this returns true if the download isn't already running but should be, and it
     * can know whether the download is already running by checking the status.
     */
